...
export const APP_ID = 'ai.yunwu.desktop'

/** Installed application name; also the userData directory name. */
export const PRODUCT_NAME = 'Yunwu Desktop'

/** Native window title. */
export const WINDOW_TITLE = '云雾'
