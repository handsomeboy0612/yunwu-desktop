...
import { b as truncateUtf16Safe, m as resolveUserPath } from "./utils-BApvfmPs.js";
...
import { a as isSubagentSessionKey, n as isAcpSessionKey, r as isCronRunSessionKey } from "./session-key-utils-C7uT9A4s.js";
import { a as resolveAgentDir, r as resolveAgentConfig } from "./agent-scope-config-C3ijpoNo.js";
import { r as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BcIVzXmF.js";
import { i as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-Dp5LgxH6.js";
...
import { a as createStreamIteratorWrapper, i as wrapStreamFnTextTransforms } from "./text-transforms.runtime-Bfe-7w9Y.js";
import { i as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-D9zzqcZX.js";
import { N as listRegisteredPluginAgentPromptGuidance } from "./command-registration-a7OJxeW9.js";
import { p as listImportedRuntimePluginIds, s as getActivePluginRegistry } from "./runtime-B87Ul6vY.js";
...
import { s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-BvDdPqDN.js";
import { m as setReplyPayloadMetadata } from "./reply-payload-HLWc9ssO.js";
import { s as resolveContextEngineOwnerPluginId } from "./registry-BLZQzICr.js";
import { r as MAX_IMAGE_BYTES } from "./constants-Mf57IYS0.js";
import { G as parseSessionThreadInfoFast, U as resolveQuotaSuspensionEntryMaintenance } from "./store-jR_nVe0n.js";
import { d as resolveStorePath } from "./paths-CHZBIGhF.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-BFG5Kqze.js";
...
import { i as normalizeMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-DleKV4yQ.js";
import "./message-channel-B4LS2Kcc.js";
import { a as resolveSessionLockMaxHoldFromTimeout, s as resolveSessionWriteLockOptions, t as acquireSessionWriteLock } from "./session-write-lock-B7bsl0mX.js";
import { r as isSessionWriteLockAcquireError } from "./session-write-lock-error-CYOzPsPk.js";
import { P as updateSessionEntry, U as isTranscriptOnlyOpenClawAssistantMessage$1, f as listSessionEntries, m as loadSessionEntry } from "./session-accessor-DvSc996e.js";
...
import { d as resolveProviderRuntimePluginHandle } from "./provider-hook-runtime-CPEpF8QC.js";
import { M as resolveProviderTextTransforms, U as transformProviderSystemPrompt, j as resolveProviderSystemPromptContribution } from "./provider-runtime-Cb_NPY4Q.js";
import { n as parseBooleanValue } from "./boolean-CrriykWV.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-8gdGyO--.js";
import { t as sanitizeForConsole } from "./console-sanitize-Bf1BpkZq.js";
import { o as normalizeProviderId$1 } from "./model-selection-normalize-Df7baLev.js";
...
import { o as createAgentSession, tt as wrapToolDefinition } from "./sessions-JU-Nr-nC.js";
import { l as invalidateSessionFileRepairCache, t as SessionManager, u as repairSessionFileIfNeeded } from "./session-manager-D5YeJxMM.js";
...
import { f as resolveModelAuthMode } from "./model-auth-Bjx4UCgB.js";
import { m as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace--BzZU8fC.js";
...
import { U as isTerminalTaskStatus } from "./task-registry-ey_nCwzr.js";
import { A as scrubOverCapPlainTextToolCallMessage, D as extractStandalonePlainTextToolCallText, O as promoteStandalonePlainTextToolCallMessage, T as streamWithPayloadPatch, k as normalizePlainTextToolCallStreamEvents } from "./provider-stream-shared-CDfVnM8B.js";
...
import { C as resolveEmbeddedSessionFileKey, b as updateActiveEmbeddedRunSnapshot, d as markActiveEmbeddedRunAbandoned, r as clearActiveEmbeddedRun, v as setActiveEmbeddedRun, y as updateActiveEmbeddedRunSessionFile } from "./runs-axTpTpGH.js";
...
import { l as formatUserFacingAssistantErrorText, p as isCloudCodeAssistFormatError, r as classifyFailoverReason } from "./errors-C4-qHiKh.js";
...
import { c as isSignalTimeoutReason } from "./failover-error-CZc6_Wx_.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-CBQ2d2jT.js";
import { o as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-QWt2hSdK.js";
import { a as resolveInheritedToolPolicyForSession, i as resolveGroupToolPolicy, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy } from "./agent-tools.policy-Bvvs8fk8.js";
...
import { A as resolveChannelReactionGuidance, D as listChannelSupportedActions, F as consumeStructuredReplaySafeToolCall, M as getChannelAgentToolMeta, N as consumeAdjustedParamsForToolCall, O as resolveChannelMessageToolHints, P as consumePreExecutionBlockedToolCall, u as recordStructuredReplayTrustForToolCall, v as CODE_MODE_EXEC_TOOL_NAME, y as CODE_MODE_WAIT_TOOL_NAME } from "./agent-tools.before-tool-call-DoAeVDTL.js";
import { i as getPluginToolMeta } from "./tools-BVgZKS33.js";
import { r as resolveImageSanitizationLimits } from "./image-sanitization-CxLP0YN-.js";
import { r as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-wDx6WgK1.js";
import { t as resolveSenderToolPolicy } from "./sender-tool-policy-BYTwoeTz.js";
import { n as OPENCLAW_EMBEDDED_CONTEXT_ENGINE_HOST, r as assertContextEngineHostSupport } from "./host-compat-BibWlia2.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-Nofb8bX9.js";
...
import { a as finalizeHarnessContextEngineTurn, c as runContextEngineMaintenance, d as runAgentEndSideEffects, f as buildContextEngineRuntimeSettings, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-Cyu8bhtZ.js";
import { E as isEmbeddedMode, d as replaceWithEffectiveCronCreatorToolAllowlist, m as stripProviderPrefix, p as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-DnJ9m035.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-kjCUeRNK.js";
import { t as getMachineDisplayName } from "./machine-name-DaF-eeRE.js";
import { _ as supportsModelTools, f as sanitizeTransportPayloadText, g as buildGuardedModelFetch, m as hasOnlyAssistantReasoningContent, u as mergeTransportHeaders } from "./openai-transport-stream-Dj78Cdnf.js";
import { t as log$2 } from "./logger-DibNup0x.js";
import { u as createCodexNativeWebSearchWrapper } from "./proxy-nAMiii2R.js";
...
import { o as buildCodeSpanIndex, s as createInlineCodeState } from "./openai-completions-DTj6G8AI.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-DAJmt9jr.js";
...
import { c as resolveSkillsPromptForRun } from "./workspace-CD16JXyF.js";
import { n as resolveSandboxSkillRuntimeInputs, r as resolveEmbeddedRunSkillEntries, t as mapSandboxSkillEntriesForPrompt } from "./sandbox-skills-BtkGHoiR.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-BEzLoYKL.js";
...
import { t as registerProviderStreamForModel } from "./provider-stream-B5ruZ4qc.js";
import { b as prependAgentSteeringPrompt, g as releasePendingAgentSteeringItems, t as ackPendingAgentSteeringItems, u as leasePendingAgentSteeringItems } from "./subagent-registry-Bvmo-OI6.js";
import { n as buildSubagentList } from "./subagent-list-D8-qWUdM.js";
import { a as listControlledSubagentRuns } from "./subagent-control-DvT-t04r.js";
import { o as resolveSandboxContext } from "./sandbox-B-4himLl.js";
import { r as listActiveProcessSessionReferences } from "./compaction-runtime-context-DiDns5g3.js";
...
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DSoMn4XR.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-QFOE5bY3.js";
import { i as resolveCodeModeConfig, n as applyCodeModeCatalog, r as createCodeModeTools, t as addClientToolsToCodeModeCatalog } from "./code-mode-BaNf9Jkf.js";
...
import { i as runAgentHarnessBeforeAgentFinalizeHook } from "./lifecycle-hook-helpers-DDHcUGwO.js";
import { i as resolveAgentPromptSurfaceForSessionKey, n as appendModelIdentitySystemPrompt, r as buildModelIdentityPromptLine } from "./system-prompt-config-Bcju_E_y.js";
import { t as collectRuntimeChannelCapabilities } from "./runtime-capabilities-DF95nxSD.js";
import { n as filterRuntimeCompatibleTools } from "./tool-schema-projection-Bld_BaX8.js";
import { n as normalizeAgentRuntimeTools, t as logAgentRuntimeToolDiagnostics } from "./tools-C1xwKwzX.js";
import { c as truncateOversizedToolResultsInMessages, f as formatContextLimitTruncationNotice, o as resolveLiveToolResultMaxChars, r as createToolResultPromptProjectionState, u as truncateOversizedToolResultsInSessionManager } from "./tool-result-truncation-BsqQfexn.js";
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-rewrite-Cl3r_xqG.js";
...
import { a as estimateLlmBoundaryTokenPressure, c as shouldPreemptivelyCompactBeforePrompt, i as buildPrePromptContextBudgetStatus, l as collectReplaySafeToolNames, n as runAgentCleanupStep, r as PREEMPTIVE_OVERFLOW_ERROR_TEXT, s as formatPrePromptPrecheckLog, t as buildEmbeddedAttemptToolRunContext, u as isAgentToolReplaySafe } from "./attempt.tool-run-context-BdvQvDEH.js";
import { c as resolveCompactionTimeoutMs, d as shouldAllowProviderOwnedThinkingReplay, u as resolveTranscriptPolicy } from "./tool-result-middleware-CqP5wzKG.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-DF7AsEps.js";
...
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-BQMBh27m.js";
import { r as resolveEmbeddedSandboxInfoExecPolicy, t as buildEmbeddedSandboxInfo } from "./sandbox-info-CivYFixE.js";
...
import { i as listTasksForOwnerOrRequesterSessionKeyForStatus, t as findTaskByRunIdForStatus } from "./task-status-access-CYxzBvpG.js";
import { n as formatZonedTimestamp } from "./format-datetime-DO2rqkXr.js";
import "./tool-loop-detection-BY1T2Ibo.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-Db1jMM1F.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-cZHIw6Jd.js";
import { t as detectAndLoadPromptImages } from "./images-CqIPCk-1.js";
...
* telemetry.
*/
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-C_GgeDgJ.js"));
